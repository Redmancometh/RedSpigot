...
public abstract class JavaPlugin extends PluginBase {
	...
	public AnnotationConfigApplicationContext buildContext() {
	 ...
	 * {@link #getProvidingPlugin(Class) provided} the given plugin class, which
	 * is usually the plugin that implemented it.
	 * <p>
	 * An exception to this would be if plugin's jar that contained the class
	 * does not extend the class, where the intended plugin would have resided
	 * in a different jar / classloader.
	 *
	 * @param <T>
	 *            a class that extends JavaPlugin
	 * @param clazz
	 *            the class desired
