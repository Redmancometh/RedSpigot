...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
	...
	public boolean teleport(Location location, TeleportCause cause) {
		...
		// If this entity is riding another entity, we must dismount before
		// teleporting.
		entity.stopRiding();
		...
		entity.world.entityJoinedWorld(entity, false); // Spigot - register to
														// new chunk
	...
	public org.bukkit.entity.Entity getVehicle() {
		...
		return getHandle().bJ().getBukkitEntity(); // PAIL: rename getVehicle()
													// -> getRootVehicle(), bJ()
													// -> getVehicle()
	}
