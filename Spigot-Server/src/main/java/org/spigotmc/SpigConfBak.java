...
public class SpigConfBak {
	...
	public static void init(File configFile) {
		...
		readConfig(SpigConfBak.class, null);
	}

	public static void registerCommands() {
		for (Map.Entry<String, Command> entry : commands.entrySet()) {
			System.out.println("MCS: " + (MinecraftServer.getServer() == null));
			System.out.println("MCSS: " + (MinecraftServer.getServer().server == null));
	...
	static void readConfig(Class<?> clazz, Object instance) {
		Logger.getLogger("spigot-conf-logger").info("Reading spigot config of clasS: " + clazz);
	...
	private static void replaceCommands() {
		...
		replaceCommands = new HashSet<String>(
				(List<String>) getList("commands.replace-commands", Arrays.asList("setblock", "summon", "testforblock", "tellraw")));
	}
	...
	private static void attributeMaxes() {
		...
		((AttributeRanged) attr.maxHealth).b = maxHealth;
		movementSpeed = getDouble("settings.attribute.movementSpeed.max", movementSpeed);
		((AttributeRanged) attr.MOVEMENT_SPEED).b = movementSpeed;
		attackDamage = getDouble("settings.attribute.attackDamage.max", attackDamage);
		((AttributeRanged) attr.ATTACK_DAMAGE).b = attackDamage;
		*/
	}
