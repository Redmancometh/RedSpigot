...
public class EntitySlime extends EntityInsentient implements IMonster {
	...
	public void setSize(int i, boolean flag) {
		...
		this.getAttributeInstance(attr.maxHealth).setValue((double) (i * i));
		this.getAttributeInstance(attr.MOVEMENT_SPEED).setValue((double) (0.2F + 0.1F * (float) i));
		if (flag) {
	...
	public void die() {
		...
		if (!this.world.isClientSide && i > 1 && this.getHealth() <= 0.0F) {
			...
			for (int k = 0; k < j; ++k) {
				...
				entityslime.setPositionRotation(this.locX + (double) f, this.locY + 0.5D, this.locZ + (double) f1, this.random.nextFloat() * 360.0F,
						0.0F);
	...
	protected void e(EntityLiving entityliving) {
		...
		if (this.hasLineOfSight(entityliving) && this.h(entityliving) < 0.6D * (double) i * 0.6D * (double) i
				&& entityliving.damageEntity(DamageSource.mobAttack(this), (float) this.di())) {
	...
	public boolean P() {
		...
		if (this.world.getWorldData().getType() == WorldType.FLAT && this.random.nextInt(4) != 1) {
			...
			if (this.world.getDifficulty() != EnumDifficulty.PEACEFUL) {
				...
				if (biomebase == Biomes.h && this.locY > 50.0D && this.locY < 70.0D && this.random.nextFloat() < 0.5F
						&& this.random.nextFloat() < this.world.G() && this.world.getLightLevel(new BlockPosition(this)) <= this.random.nextInt(8)) {
					return super.P();
				}
	...
	static class PathfinderGoalSlimeRandomDirection extends PathfinderGoal {
		...
		public boolean a() {
			return this.a.getGoalTarget() == null
					&& (this.a.onGround || this.a.isInWater() || this.a.au() || this.a.hasEffect(MobEffects.LEVITATION));
		}
	...
	static class PathfinderGoalSlimeNearestPlayer extends PathfinderGoal {
		...
		public boolean a() {
			...
			return entityliving == null
					...
					: (!entityliving.isAlive()
							? false
							: !(entityliving instanceof EntityHuman) || !((EntityHuman) entityliving).abilities.isInvulnerable);
		}
		...
		public boolean b() {
			...
			return entityliving == null
					...
					: (!entityliving.isAlive()
							? false
							: (entityliving instanceof EntityHuman && ((EntityHuman) entityliving).abilities.isInvulnerable ? false : --this.b > 0));
		}
	...
	class ControllerMoveSlime extends ControllerMove {
		...
		public void a() {
			...
			if (this.h != ControllerMove.Operation.MOVE_TO) {
				...
				if (this.a.onGround) {
					this.a.k((float) (this.e * this.a.getAttributeInstance(attr.MOVEMENT_SPEED).getValue()));
					if (this.j-- <= 0) {
						this.j = this.k.df();
						if (this.l) {
							this.j /= 3;
						...
						if (this.k.dn()) {
							this.k.a(this.k.dk(), this.k.cq(),
									((this.k.getRandom().nextFloat() - this.k.getRandom().nextFloat()) * 0.2F + 1.0F) * 0.8F);
						}
					} else {
						this.k.be = 0.0F;
						this.k.bg = 0.0F;
