...
public abstract class BlockFluids extends Block {
	...
	protected Vec3D a(IBlockAccess iblockaccess, BlockPosition blockposition, IBlockData iblockdata) {
		...
		if (((Integer) iblockdata.get(BlockFluids.LEVEL)).intValue() >= 8) {
			...
			while (iterator1.hasNext()) {
				...
				if (this.a(iblockaccess, (BlockPosition) blockposition_pooledblockposition, enumdirection1)
						|| this.a(iblockaccess, blockposition_pooledblockposition.up(), enumdirection1)) {
	...
	protected void fizz(World world, BlockPosition blockposition) {
		...
		world.a((EntityHuman) null, blockposition, SoundEffects.dE, SoundCategory.BLOCKS, 0.5F,
	...
	public BlockFlowing a(Material material) {
	...
	public BlockStationary b(Material material) {
		if (material == Material.WATER) {
			return blocks.WATER;
		} else if (material == Material.LAVA) {
			return blocks.LAVA;
