...
public class PacketStatusListener implements PacketStatusInListener {
	...
	public void a(PacketStatusInStart packetstatusinstart) {
		if (this.d) {
			...
			this.d = true;
			// CraftBukkit start
			// this.networkManager.sendPacket(new
			// PacketStatusOutServerInfo(this.minecraftServer.getServerPing()));
			...
			if (!profiles.isEmpty()) {
				...
				profiles = profiles.subList(0, Math.min(profiles.size(), cfg.getSampleCount()));
			}
			// Spigot End
