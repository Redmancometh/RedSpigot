...
public class ItemRedstone extends Item {
	...
	public EnumInteractionResult a(EntityHuman entityhuman, World world, BlockPosition blockposition, EnumHand enumhand, EnumDirection enumdirection,
		...
		if (!itemstack.isEmpty() && entityhuman.a(blockposition1, enumdirection, itemstack)
				&& world.a(world.getType(blockposition1).getBlock(), blockposition1, false, enumdirection, (Entity) null)
				&& blocks.REDSTONE_WIRE.canPlace(world, blockposition1)) { // CraftBukkit
