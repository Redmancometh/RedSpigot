...
public class BlockMonsterEggs extends Block {
	...
	public boolean x(IBlockData iblockdata) {
		...
		return iblockdata == blocks.STONE.getBlockData().set(BlockStone.VARIANT, BlockStone.EnumStoneVariant.STONE) || block == blocks.COBBLESTONE
	...
	public void dropNaturally(World world, BlockPosition blockposition, IBlockData iblockdata, float f, int i) {
		if (!world.isClientSide && world.getGameRules().getBoolean("doTileDrops")) {
			...
			world.addEntity(entitysilverfish, SpawnReason.SILVERFISH_BLOCK); // CraftBukkit
																				// -
																				// add
																				// SpawnReason
	...
	// TODON: Idk what to do about this one. This is facked.
