...
public class TileEntityBeacon extends TileEntityContainer implements ITickable, IWorldInventory {
	...
	public static final MobEffectList[][] a = new MobEffectList[][]{{MobEffects.FASTER_MOVEMENT, MobEffects.FASTER_DIG},
			{MobEffects.RESISTANCE, MobEffects.JUMP}, {MobEffects.INCREASE_DAMAGE}, {MobEffects.REGENERATION}};
	...
	public PotionEffect getPrimaryEffect() {
		return (this.primaryEffect != null) ? potions.toBukkit(new MobEffect(this.primaryEffect, getLevel(), getAmplification(), true, true)) : null;
	}

	public PotionEffect getSecondaryEffect() {
		return (hasSecondaryEffect()) ? potions.toBukkit(new MobEffect(this.secondaryEffect, getLevel(), getAmplification(), true, true)) : null;
	}
	// CraftBukkit end
	...
	public List getHumansInRange() {
		{
			...
			AxisAlignedBB axisalignedbb = (new AxisAlignedBB((double) j, (double) k, (double) l, (double) (j + 1), (double) (k + 1),
					(double) (l + 1))).g(d0).b(0.0D, (double) this.world.getHeight(), 0.0D);
	...
	private void F() {
		...
		if (!this.world.isClientSide && l < this.levels) {
			Iterator iterator = this.world.a(EntityPlayer.class,
					(new AxisAlignedBB((double) i, (double) j, (double) k, (double) i, (double) (j - 4), (double) k)).grow(10.0D, 5.0D, 10.0D))
					.iterator();
	...
	@Nullable
	private MobEffectList f(int i) {
		MobEffectList mobeffectlist = effectRegistry.getId(i);
		return TileEntityBeacon.f.contains(mobeffectlist) ? mobeffectlist : null;
	}

	public void load(NBTTagCompound nbttagcompound) {
		super.load(nbttagcompound);
		// Craftbukkit start - persist manually set non-default beacon effects
		// (SPIGOT-3598)
		this.primaryEffect = effectRegistry.getId(nbttagcompound.getInt("Primary"));
		this.secondaryEffect = effectRegistry.getId(nbttagcompound.getInt("Secondary"));
		// Craftbukkit end
	...
	public NBTTagCompound save(NBTTagCompound nbttagcompound) {
		...
		nbttagcompound.setInt("Primary", effectRegistry.a(this.primaryEffect));
		nbttagcompound.setInt("Secondary", effectRegistry.a(this.secondaryEffect));
	...
	public boolean b(int i, ItemStack itemstack) {
		return itemstack.getItem() == Items.EMERALD || itemstack.getItem() == Items.DIAMOND || itemstack.getItem() == Items.GOLD_INGOT
	...
	public int getProperty(int i) {
		switch (i) {
			...
			case 1 :
				return effectRegistry.a(this.primaryEffect);

			case 2 :
				return effectRegistry.a(this.secondaryEffect);
