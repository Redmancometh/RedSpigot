	...
	public void a(CrashReportSystemDetails crashreportsystemdetails) {
		...
		if (this.world != null) {
			...
			crashreportsystemdetails.a("Actual block type", new CrashReportCallable() {
				public String a() throws Exception {
					int i = blockRegistry.getId(TileEntity.this.world.getType(TileEntity.this.position).getBlock());

					try {
						return String.format("ID #%d (%s // %s)", new Object[]{Integer.valueOf(i), blockRegistry.getById(i).a(),
								blockRegistry.getById(i).getClass().getCanonicalName()});
					} catch (Throwable throwable) {
						return "ID #" + i;
					}
				}
