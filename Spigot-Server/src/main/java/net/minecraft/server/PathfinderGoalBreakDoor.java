...
public class PathfinderGoalBreakDoor extends PathfinderGoalDoorInteract {
	...
	public void e() {
		...
		if (this.g == 240 && this.a.world.getDifficulty() == EnumDifficulty.HARD) {
			// CraftBukkit start
			if (org.bukkit.craftbukkit.event.CraftEventFactory.callEntityBreakDoorEvent(this.a, this.b.getX(), this.b.getY(), this.b.getZ())
					.isCancelled()) {
				this.c();
				return;
			}
			...
			this.a.world.triggerEffect(2001, this.b, blockRegistry.getId(this.c));
		}
