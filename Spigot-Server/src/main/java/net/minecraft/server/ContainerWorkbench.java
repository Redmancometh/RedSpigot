...
public class ContainerWorkbench extends Container {
	...
	public InventoryCrafting craftInventory; // CraftBukkit - move
												// initialization into
												// constructor
	public InventoryCraftResult resultInventory; // CraftBukkit - move
													// initialization into
													// constructor
	...
	public ContainerWorkbench(PlayerInventory playerinventory, World world, BlockPosition blockposition) {
		// CraftBukkit start - Switched order of IInventory construction and
		// stored player
		this.resultInventory = new InventoryCraftResult();
		this.craftInventory = new InventoryCrafting(this, 3, 3, playerinventory.player); // CraftBukkit
																							// -
																							// pass
																							// player
	...
	public boolean canUse(EntityHuman entityhuman) {
		...
		return this.g.getType(this.h).getBlock() != blocks.CRAFTING_TABLE
				? false
				: entityhuman.d((double) this.h.getX() + 0.5D, (double) this.h.getY() + 0.5D, (double) this.h.getZ() + 0.5D) <= 64.0D;
	}
