...
public class ChunkProviderGenerate implements ChunkGenerator {
	...
	protected IBlockData a = blocks.STONE.getBlockData();
	...
	public boolean a(World world, String s, BlockPosition blockposition) {
		return !this.o
				? false
				: ("Stronghold".equals(s) && this.w != null
						? this.w.b(blockposition)
						: ("Mansion".equals(s) && this.C != null
								? this.C.b(blockposition)
								: ("Monument".equals(s) && this.B != null
										? this.B.b(blockposition)
										: ("Village".equals(s) && this.x != null
												? this.x.b(blockposition)
												: ("Mineshaft".equals(s) && this.y != null
														? this.y.b(blockposition)
														: ("Temple".equals(s) && this.z != null ? this.z.b(blockposition) : false))))));
	}
								...
								: ("Monument".equals(s) && this.B != null
										...
										: ("Village".equals(s) && this.x != null
												...
												: ("Mineshaft".equals(s) && this.y != null
														...
														: ("Temple".equals(s) && this.z != null
																? this.z.getNearestGeneratedFeature(world, blockposition, flag)
																: null))))));
	}
