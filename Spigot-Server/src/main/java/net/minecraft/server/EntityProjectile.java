...
public abstract class EntityProjectile extends Entity implements IProjectile {
	...
	public void B_() {
		...
		for (int i = 0; i < list.size(); ++i) {
			...
			if (entity1.isInteractable()) {
				if (entity1 == this.d) {
					flag = true;
				} else if (this.shooter != null && this.ticksLived < 2 && this.d == null && this.shooter == entity1) { // CraftBukkit
																														// -
																														// MC-88491
					this.d = entity1;
					flag = true;
	...
	public void b(NBTTagCompound nbttagcompound) {
		...
		MinecraftKey minecraftkey = (MinecraftKey) blockRegistry.b(this.inBlockId);
	...
	public void a(NBTTagCompound nbttagcompound) {
		...
		if (nbttagcompound.hasKeyOfType("inTile", 8)) {
			this.inBlockId = blockRegistry.getByName(nbttagcompound.getString("inTile"));
		} else {
			this.inBlockId = blockRegistry.getById(nbttagcompound.getByte("inTile") & 255);
		}
