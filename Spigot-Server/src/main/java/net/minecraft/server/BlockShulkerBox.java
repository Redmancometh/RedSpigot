...
public class BlockShulkerBox extends BlockTileEntity {
		...
		if (world.isClientSide) {
			...
			if (tileentity instanceof TileEntityShulkerBox) {
				...
				if (((TileEntityShulkerBox) tileentity).p() == TileEntityShulkerBox.AnimationPhase.CLOSED) {
					AxisAlignedBB axisalignedbb = BlockShulkerBox.j.b((double) (0.5F * (float) enumdirection1.getAdjacentX()),
							(double) (0.5F * (float) enumdirection1.getAdjacentY()), (double) (0.5F * (float) enumdirection1.getAdjacentZ()))
							.a((double) enumdirection1.getAdjacentX(), (double) enumdirection1.getAdjacentY(),
									(double) enumdirection1.getAdjacentZ());
	...
	public void dropNaturally(World world, BlockPosition blockposition, IBlockData iblockdata, float f, int i) {
		...
		if (tileentity instanceof TileEntityShulkerBox) {
			...
			if (!tileentityshulkerbox.r() && tileentityshulkerbox.F()) {
				ItemStack itemstack = new ItemStack(items.getItemOf(this));
	...
	public void remove(World world, BlockPosition blockposition, IBlockData iblockdata) {
		...
		world.updateAdjacentComparators(blockposition, iblockdata.getBlock()); // CraftBukkit
																				// -
																				// moved
																				// down
	...
	public Block a(EnumColor enumcolor) {
		switch (enumcolor) {
			case WHITE :
	...
	public ItemStack b(EnumColor enumcolor) {
	...
	public EnumBlockFaceShape a(IBlockAccess iblockaccess, IBlockData iblockdata, BlockPosition blockposition, EnumDirection enumdirection) {
		...
		EnumDirection enumdirection1 = (EnumDirection) iblockdata.get(BlockShulkerBox.a);
		TileEntityShulkerBox.AnimationPhase tileentityshulkerbox_animationphase = ((TileEntityShulkerBox) iblockaccess.getTileEntity(blockposition))
				.p();

		return tileentityshulkerbox_animationphase != TileEntityShulkerBox.AnimationPhase.CLOSED
				&& (tileentityshulkerbox_animationphase != TileEntityShulkerBox.AnimationPhase.OPENED
						|| enumdirection1 != enumdirection.opposite() && enumdirection1 != enumdirection)
