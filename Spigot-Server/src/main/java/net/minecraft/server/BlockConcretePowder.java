...
public class BlockConcretePowder extends BlockFalling {
	...
	public void a(World world, BlockPosition blockposition, IBlockData iblockdata, IBlockData iblockdata1) {
		if (iblockdata1.getMaterial().isLiquid() && world.getType(blockposition).getBlock() != blocks.dR) { // CraftBukkit
																											// -
																											// don't
																											// double
																											// concrete
			org.bukkit.craftbukkit.event.CraftEventFactory.handleBlockFormEvent(world, blockposition,
					blocks.dR.getBlockData().set(BlockCloth.COLOR, iblockdata.get(BlockConcretePowder.a)), null); // CraftBukkit
		}
