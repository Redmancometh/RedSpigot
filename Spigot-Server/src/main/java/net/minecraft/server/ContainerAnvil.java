...
public class ContainerAnvil extends Container {
	...
	public ContainerAnvil(PlayerInventory playerinventory, final World world, final BlockPosition blockposition, EntityHuman entityhuman) {
		...
		this.a(new Slot(this.g, 2, 134, 47) {
			...
			public boolean isAllowed(EntityHuman entityhuman) {
				return (entityhuman.abilities.canInstantlyBuild || entityhuman.expLevel >= ContainerAnvil.this.levelCost)
						&& ContainerAnvil.this.levelCost > 0 && this.hasItem();
			}
			...
			public ItemStack a(EntityHuman entityhuman, ItemStack itemstack) {
				...
				if (!entityhuman.abilities.canInstantlyBuild && !world.isClientSide && iblockdata.getBlock() == blocks.ANVIL
						&& entityhuman.getRandom().nextFloat() < 0.12F) {
	...
	public boolean canUse(EntityHuman entityhuman) {
		...
		return this.i.getType(this.j).getBlock() != blocks.ANVIL
				? false
				: entityhuman.d((double) this.j.getX() + 0.5D, (double) this.j.getY() + 0.5D, (double) this.j.getZ() + 0.5D) <= 64.0D;
	}
