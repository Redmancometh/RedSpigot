...
public class ItemBlock extends Item {
	...
	public EnumInteractionResult a(EntityHuman entityhuman, World world, BlockPosition blockposition, EnumHand enumhand, EnumDirection enumdirection,
		...
		if (!itemstack.isEmpty() && entityhuman.a(blockposition, enumdirection, itemstack)
				&& world.a(this.a, blockposition, false, enumdirection, (Entity) null)) {
			...
			if (world.setTypeAndData(blockposition, iblockdata1, 11)) {
				...
				// world.a(entityhuman, blockposition, soundeffecttype.e(),
				// SoundCategory.BLOCKS, (soundeffecttype.a() + 1.0F) / 2.0F,
				// soundeffecttype.b() * 0.8F); // CraftBukkit - SPIGOT-1288
