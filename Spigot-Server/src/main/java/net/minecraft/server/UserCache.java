...
public class UserCache {
	...
	public GameProfile getProfile(String s) {
		...
		if (usercache_usercacheentry != null) {
			...
			gameprofile = a(this.g, s); // Spigot - use correct case for offline
										// players
			if (gameprofile != null) {
				this.a(gameprofile);
	...
	public void c() {
		String s = this.b.toJson(this.a(cfg.getUserCacheSize()));
	...
	class BanEntrySerializer implements JsonDeserializer<UserCache.UserCacheEntry>, JsonSerializer<UserCache.UserCacheEntry> {
		...
		public JsonElement serialize(UserCacheEntry object, Type type, JsonSerializationContext jsonserializationcontext) { // CraftBukkit
																															// -
																															// decompile
																															// error
