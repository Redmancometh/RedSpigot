...
public class Block {
	...
	public static void w() {
		...
		a(70, "stone_pressure_plate", (new BlockPressurePlateBinary(Material.STONE, BlockPressurePlateBinary.EnumMobType.MOBS)).c(0.5F)
		...
		a(72, "wooden_pressure_plate", (new BlockPressurePlateBinary(Material.WOOD, BlockPressurePlateBinary.EnumMobType.EVERYTHING)).c(0.5F)
		...
		a(202, "purpur_pillar", (new BlockRotatable(Material.STONE, MaterialMapColor.s)).c(1.5F).b(10.0F).a(SoundEffectType.d).a(CreativeModeTab.b)
				.c("purpurPillar"));
		...
		while (iterator1.hasNext()) {
			...
			if (hashset.contains(block16)) {
				for (int i = 0; i < 15; ++i) {
					int j = Block.REGISTRY.a(block16) << 4 | i; // CraftBukkit -
																// decompile
																// error
				...
				while (unmodifiableiterator.hasNext()) {
					...
					int k = Block.REGISTRY.a(block16) << 4 | block16.toLegacyData(iblockdata); // CraftBukkit
																								// -
																								// decompile
																								// error
