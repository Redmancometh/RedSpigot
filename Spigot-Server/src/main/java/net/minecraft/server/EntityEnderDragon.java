...
public class EntityEnderDragon extends EntityInsentient implements IComplex, IMonster {
    ...
    protected static final Logger bJ = LogManager.getLogger();
    ...
    protected final EnderDragonBattle bK;
    protected final DragonControllerManager bL;
    protected int bM = 200;
    protected int bN;
    protected final PathPoint[] bO = new PathPoint[24];
    protected final int[] bP = new int[24];
    protected final Path bQ = new Path();
    protected Explosion explosionSource = new Explosion(null, this, Double.NaN, Double.NaN, Double.NaN, Float.NaN, true, true); // CraftBukkit - reusable source for CraftTNTPrimed.getSource()
    ...
    protected void b(List<Entity> list) {
    ...
    protected float c(double d0) {
        return (float) MathHelper.g(d0);
    }

    protected boolean b(AxisAlignedBB axisalignedbb) {
    ...
    protected PathEntity a(PathPoint pathpoint, PathPoint pathpoint1) {
        int i = 1;
