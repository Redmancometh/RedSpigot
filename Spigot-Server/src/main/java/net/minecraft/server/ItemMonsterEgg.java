...
public class ItemMonsterEgg extends Item {
	...
	public EnumInteractionResult a(EntityHuman entityhuman, World world, BlockPosition blockposition, EnumHand enumhand, EnumDirection enumdirection,
		...
		if (world.isClientSide) {
			...
			Entity entity = a(world, h(itemstack), (double) blockposition1.getX() + 0.5D, (double) blockposition1.getY() + d0,
		...
		if (world.isClientSide) {
			...
			if (movingobjectposition != null && movingobjectposition.type == MovingObjectPosition.EnumMovingObjectType.BLOCK) {
				...
				if (!(world.getType(blockposition).getBlock() instanceof BlockFluids)) {
					...
					Entity entity = a(world, h(itemstack), (double) blockposition.getX() + 0.5D, (double) blockposition.getY() + 0.5D,
	...
	@Nullable
	public static Entity spawnCreature(World world, @Nullable MinecraftKey minecraftkey, double d0, double d1, double d2,
		...
		if (minecraftkey != null && EntityTypes.eggInfo.containsKey(minecraftkey)) {
			...
			for (int i = 0; i < 1; ++i) {
				...
				if (entity instanceof EntityInsentient) {
					...
					// CraftBukkit start - don't return an entity when
					// CreatureSpawnEvent is canceled
