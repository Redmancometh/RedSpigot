...
public class TileEntityCommand extends TileEntity {
	...
	private final CommandBlockListenerAbstract i = new CommandBlockListenerAbstract() {
		{
			sender = new org.bukkit.craftbukkit.command.CraftBlockCommandSender(this); // CraftBukkit
																						// -
																						// add
																						// sender
		}
		...
		public Vec3D d() {
			return new Vec3D((double) TileEntityCommand.this.position.getX() + 0.5D, (double) TileEntityCommand.this.position.getY() + 0.5D,
	...
	public TileEntityCommand.Type l() {
		...
		return block == blocks.COMMAND_BLOCK
				? TileEntityCommand.Type.REDSTONE
				: (block == blocks.dc
						? TileEntityCommand.Type.AUTO
						: (block == blocks.dd ? TileEntityCommand.Type.SEQUENCE : TileEntityCommand.Type.REDSTONE));
	}
