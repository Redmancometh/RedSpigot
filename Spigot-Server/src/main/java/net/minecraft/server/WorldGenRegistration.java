...
public class WorldGenRegistration {
	...
	public class b extends WorldGenRegistration.WorldGenScatteredPiece {

		private MinecraftKey e = new MinecraftKey("igloo/igloo_top");
		private MinecraftKey f = new MinecraftKey("igloo/igloo_middle");
		private MinecraftKey g = new MinecraftKey("igloo/igloo_bottom");
		...
		public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
			if (!this.a(world, structureboundingbox, -1)) {
				...
				DefinedStructureInfo definedstructureinfo = (new DefinedStructureInfo())
						.a(aenumblockrotation[random.nextInt(aenumblockrotation.length)]).a(blocks.dj).a(structureboundingbox1);
				...
				if (random.nextDouble() < 0.5D) {
					...
					for (int j = 0; j < i; ++j) {
						BlockPosition blockposition1 = definedstructure.a(definedstructureinfo, new BlockPosition(3, -1 - j * 3, 5),
								definedstructureinfo, new BlockPosition(1, 2, 1));

						definedstructure1.a(world, blockposition.a((BaseBlockPosition) blockposition1), definedstructureinfo);
					}

					BlockPosition blockposition2 = blockposition.a((BaseBlockPosition) definedstructure.a(definedstructureinfo,
							new BlockPosition(3, -1 - i * 3, 5), definedstructureinfo, new BlockPosition(3, 5, 7)));
	...
	public class WorldGenWitchHut extends WorldGenRegistration.WorldGenScatteredPiece {
		...
		public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
			if (!this.a(world, structureboundingbox, 0)) {
				...
				this.a(world, structureboundingbox, 1, 1, 1, 5, 1, 7, blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()),
						blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()), false);
				this.a(world, structureboundingbox, 1, 4, 2, 5, 4, 7, blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()),
						blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()), false);
				this.a(world, structureboundingbox, 2, 1, 0, 4, 1, 0, blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()),
						blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()), false);
				this.a(world, structureboundingbox, 2, 2, 2, 3, 3, 2, blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()),
						blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()), false);
				this.a(world, structureboundingbox, 1, 2, 3, 1, 3, 6, blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()),
						blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()), false);
				this.a(world, structureboundingbox, 5, 2, 3, 5, 3, 6, blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()),
						blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()), false);
				this.a(world, structureboundingbox, 2, 2, 7, 4, 3, 7, blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()),
						blocks.PLANKS.fromLegacyData(BlockWood.EnumLogVariant.SPRUCE.a()), false);
				...
				this.a(world, blocks.FLOWER_POT.getBlockData().set(BlockFlowerPot.CONTENTS, BlockFlowerPot.EnumFlowerPotContents.MUSHROOM_RED), 1, 3,
	...
	public class WorldGenJungleTemple extends WorldGenRegistration.WorldGenScatteredPiece {

		private boolean e;
		private boolean f;
		private boolean g;
		private boolean h;
		private final WorldGenRegistration.WorldGenJungleTemple.WorldGenJungleTemplePiece i = new WorldGenRegistration.WorldGenJungleTemple.WorldGenJungleTemplePiece(
				null);
		...
		public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
			if (!this.a(world, structureboundingbox, 0)) {
				...
				this.a(world, blocks.TRIPWIRE_HOOK.getBlockData().set(BlockTripwireHook.FACING, EnumDirection.EAST).set(BlockTripwireHook.ATTACHED,
						Boolean.valueOf(true)), 1, -3, 8, structureboundingbox);
				this.a(world, blocks.TRIPWIRE_HOOK.getBlockData().set(BlockTripwireHook.FACING, EnumDirection.WEST).set(BlockTripwireHook.ATTACHED,
						Boolean.valueOf(true)), 4, -3, 8, structureboundingbox);
				...
				this.a(world, blocks.TRIPWIRE_HOOK.getBlockData().set(BlockTripwireHook.FACING, EnumDirection.NORTH).set(BlockTripwireHook.ATTACHED,
						Boolean.valueOf(true)), 7, -3, 1, structureboundingbox);
				this.a(world, blocks.TRIPWIRE_HOOK.getBlockData().set(BlockTripwireHook.FACING, EnumDirection.SOUTH).set(BlockTripwireHook.ATTACHED,
						Boolean.valueOf(true)), 7, -3, 5, structureboundingbox);
				...
				this.a(world, blocks.UNPOWERED_REPEATER.getBlockData().set(BlockRepeater.FACING, EnumDirection.NORTH), 10, -2, 10,
		...
		class WorldGenJungleTemplePiece extends StructurePiece.StructurePieceBlockSelector {
	...
	public class WorldGenPyramidPiece extends WorldGenRegistration.WorldGenScatteredPiece {
		...
		public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
			this.a(world, structureboundingbox, 0, -4, 0, this.a - 1, 0, this.c - 1, blocks.SANDSTONE.getBlockData(), blocks.SANDSTONE.getBlockData(),
					false);

			int i;

			for (i = 1; i <= 9; ++i) {
				this.a(world, structureboundingbox, i, i, i, this.a - 1 - i, i, this.c - 1 - i, blocks.SANDSTONE.getBlockData(),
						blocks.SANDSTONE.getBlockData(), false);
				this.a(world, structureboundingbox, i + 1, i, i + 1, this.a - 2 - i, i, this.c - 2 - i, blocks.AIR.getBlockData(),
			...
			this.a(world, structureboundingbox, this.a - 5, 0, 0, this.a - 1, 9, 4, blocks.SANDSTONE.getBlockData(), blocks.AIR.getBlockData(),
					false);
			...
			this.a(world, structureboundingbox, 5, 4, 5, this.a - 6, 4, this.c - 6, blocks.SANDSTONE.getBlockData(), blocks.SANDSTONE.getBlockData(),
					false);
			this.a(world, structureboundingbox, 9, 4, 9, 11, 4, 11, blocks.AIR.getBlockData(), blocks.AIR.getBlockData(), false);
			this.a(world, structureboundingbox, 8, 1, 8, 8, 3, 8, blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()),
					blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()), false);
			this.a(world, structureboundingbox, 12, 1, 8, 12, 3, 8, blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()),
					blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()), false);
			this.a(world, structureboundingbox, 8, 1, 12, 8, 3, 12, blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()),
					blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()), false);
			this.a(world, structureboundingbox, 12, 1, 12, 12, 3, 12, blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()),
					blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()), false);
			this.a(world, structureboundingbox, 1, 1, 5, 4, 4, 11, blocks.SANDSTONE.getBlockData(), blocks.SANDSTONE.getBlockData(), false);
			this.a(world, structureboundingbox, this.a - 5, 1, 5, this.a - 2, 4, 11, blocks.SANDSTONE.getBlockData(), blocks.SANDSTONE.getBlockData(),
					false);
			this.a(world, structureboundingbox, 6, 7, 9, 6, 7, 11, blocks.SANDSTONE.getBlockData(), blocks.SANDSTONE.getBlockData(), false);
			this.a(world, structureboundingbox, this.a - 7, 7, 9, this.a - 7, 7, 11, blocks.SANDSTONE.getBlockData(), blocks.SANDSTONE.getBlockData(),
					false);
			this.a(world, structureboundingbox, 5, 5, 9, 5, 7, 11, blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()),
					blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()), false);
			...
			this.a(world, structureboundingbox, this.a - 3, 1, 3, this.a - 2, 2, 3, blocks.SANDSTONE.getBlockData(), blocks.SANDSTONE.getBlockData(),
					false);
			...
			this.a(world, blocks.STONE_SLAB.fromLegacyData(BlockDoubleStepAbstract.EnumStoneSlabVariant.SAND.a()), this.a - 2, 2, 2,
					structureboundingbox);
			...
			this.a(world, structureboundingbox, this.a - 5, 3, 5, this.a - 5, 3, 17, blocks.SANDSTONE.getBlockData(), blocks.SANDSTONE.getBlockData(),
					false);
			...
			for (i1 = 5; i1 <= 17; i1 += 2) {
				...
				this.a(world, blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()), this.a - 5, 1, i1,
						structureboundingbox);
				this.a(world, blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.CHISELED.a()), this.a - 5, 2, i1,
						structureboundingbox);
			}
			...
			this.a(world, structureboundingbox, 8, 4, 0, 12, 6, 0, blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()),
					blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()), false);
			...
			this.a(world, structureboundingbox, 8, -9, 8, 12, -9, 12, blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()),
					blocks.SANDSTONE.fromLegacyData(BlockSandStone.EnumSandstoneVariant.SMOOTH.a()), false);
